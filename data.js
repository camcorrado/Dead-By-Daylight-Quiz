const STORE = [
  {
    question:
      "Who was the first Licensed Killer to be released for Dead By Daylight?",
    answers: ["The Cannibal", "The Nightmare", "The Pig", "The Shape"],
  ...
  },
  {
    ...
    answers: ["The Trapper", "The Nurse", "The Clown", "The Huntress"],
  ...
  },
  {
    ...
    answers: ["Bill Overbeck", "Adam Francis", "Kate Denson", "Feng Min"],
  ...
  },
  {
    ...
    answers: ["The Wraith", "The Hag", "The Nightmare", "The Spirit"],
  ...
  },
  {
    ...
    answers: ["Palettes", "Survivors", "Generators", "Hooks"],
    correctAnswer: "Hooks",
  ...
  },
  {
    ...
    answers: ["Vigo", "The Entity", "Benedict Baker", "Alex"],
    correctAnswer: "Vigo",
  ...
  {
    question:
      "Which Survivor was a pizza deliveryman before being taken by The Entity?",
    answers: ["David King", "Jake Park", "Dwight Fairfield", "Jeff Johansen"],
  ...
  },
  {
    ...
    answers: ["The Ghost Face", "The Nurse", "The Doctor", "The Plague"],
  ...
  },
  {
    ...
    answers: ["The Nea", "The Plague", "The Spirit", "The Nightmare"],
  ...
  {
    question: "Camaraderie is a perk that released with which character?",
    answers: [
      "The Demogorgon",
      "Steve Harrington",
      "Nancy Wheeler",
    ...
    audio:
      "https://dbd-quiz.s3.us-east-2.amazonaws.com/Stranger_Things_Theme_Music_.mp3",
  ...
  {
    question:
      "Which Killer perk can only be activated during the End Game Collapse?",
    answers: ["Blood Warden", "Cruel Limits", "Zanshin Tactics", "Rancor"],
  ...
  },
  {
    ...
    answers: ["Head On", "Balanced Landing", "Dead Hard", "Dance With Me"],
  ...
  },
  {
    ...
    audio:
      "https://dbd-quiz.s3.us-east-2.amazonaws.com/Generator+Completed.mp3",
    audio2: null,
    alt: "Generator Artwork",
  },
  {
    question:
      "How many seconds does it take for a Survivor to open an exit gate under normal conditions?",
    answers: ["20", "25", "30", "35"],
    correctAnswer: "20",
  ...
  },
  {
    ...
    answers: ["The Plague", "The Oni", "The Spirit", "The Wraith"],
  ...
  },
  {
    ...
    answers: ["The Legion", "The Wraith", "The Clown", "The Shape"],
  ...
  {
    question:
      "What is the maximum amount of reverse bear traps The Pig can have?",
    answers: ["5", "4", "6", "7"],
    correctAnswer: "5",
  ...
  },
  {
    ...
    answers: ["The Huntress", "The Trapper", "The Doctor", "The Hag"],
  ...
  {
    question:
      "Which Survivor is the daughter of famous actress Loretta Lawrence?",
    answers: ["Jane Romero", "Kate Denson", "Claudette Morel", "Nea Karlsson"],
  ...
  },
  {
    ...
    answers: ["Nea Karlsson", "Ace Visconti", "Feng Min", "Jake Park"],
  ...
  },
  {
    ...
    answers: ["Quentin Smith", "Feng Min", "Adam Francis", "Nancy Wheeler"],
  ...
  },
  {
    ...
    answers: ["Laurie Strode", "Nancy Wheeler", "Jane Romero", "Kate Denson"],
  ...
  },
  {
    ...
    answers: ["Ace Visconti", "Jake Park", "Jane Romero", "Claudette Morel"],
  ...
  },
  {
    ...
    answers: ["Left Behind", "Skeleton Key", "Map", "Windows of Opportunity"],
  ...
  },
  {
    ...
    answers: ["David Tapp", "Quentin Smith", "Adam Francis", "Jane Romero"],
  ...
  },
  {
    ...
    answers: ["Nancy Wheeler", "Steve Harrington", "Feng Min", "Adam Francis"],
  ...
  {
    question:
      "Which Killer can have the undetectable status with the use of add-ons?",
    answers: ["The Demogorgon", "The Hag", "The Nightmare", "The Doctor"],
  ...
  },
  {
    ...
    answers: ["The Hillbilly", "The Pig", "The Trapper", "The Huntress"],
  ...
  {
    question:
      "Which Killer has an ability that negates the oblivious status effect?",
    answers: ["The Doctor", "The Nurse", "The Wraith", "The Plague"],
  ...
  },
  {
    ...
    answers: ["The Wraith", "The Hag", "The Ghost Face", "The Nightmare"],
  ...
  {
    question:
      "Including those held, how many bear traps spawn by default on a map while playing The Trapper?",
    answers: ["5", "6", "7", "8"],
    correctAnswer: "8",
  ...
  },
  {
    ...
    answers: ["Kate Denson", "Claudette Morel", "Ace Visconti", "Jane Romero"],
